...
2.  **Heatmaps**:
    -   **Purpose**: To highlight spatial patterns of pollutant concentrations and associated health outcomes.
    -   **Details**:
        -   Heatmaps were generated using the `leaflet` library, combining geographic data with pollutant concentration values.
        -   Variable intensity and color schemes allowed users to identify hotspots of high pollution and elevated hospital admissions.
3.  **Box Plots for Demographic Subgroups**:
    -   **Purpose**: To compare the impact of pollutants on specific age groups or vulnerable populations (e.g., children, elderly).
    -   **Details**:
        -   Grouped by demographic categories such as age or socioeconomic status.
        -   Showed variability in hospital admissions across block groups.
...
#### Research Question 2: How do gas concentrations affect age-specific housing density and demographics?
...
2.  **Scatter and Bubble Plots**:
    -   **Purpose**: To show correlations between pollutant levels, housing density, and demographic percentages.
    -   **Details**:
        -   X-axis: Pollutant concentration (e.g., NO₂, SO₂).
        -   Y-axis: Housing density or demographic proportions (e.g., under 13, over 70).
        -   Bubble size represented the population count or density.
3.  **Box Plots**:
...
### **Understanding the Impact of Gas Concentrations on Housing Density and Demographics**
...
#### **Unveiling the Intersection of Housing Density and Pollution**
